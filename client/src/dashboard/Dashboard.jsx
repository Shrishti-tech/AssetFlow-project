    ...
    <div className="erp-main">
      ...
      <main className="erp-content">
        ...
        <section className="dashboard-grid-main">
          <DashboardCharts />
          <NotificationPanel open={noticeOpen} items={items} onClose={() => setNoticeOpen(false)} onRead={(id) => setItems((current) => current.map((item) => item.id === id ? { ...item, read: true } : item))} onReadAll={() => setItems((current) => current.map((item) => ({ ...item, read: true })))} />
